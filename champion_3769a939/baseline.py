...
class FM:
    ...
    def step_bpr(self, Xpos, Xneg):
        ...
        d = zpos - zneg
        gpos = (-sigmoid(-d) / B).astype(np.float32)
        gneg = -gpos
        gV = np.zeros_like(self.V); gW = np.zeros_like(self.W)
